...
import InstructorTransactionHistory from "../pages/Instructor/InstructorTransactionHistory";
  ...
  return (
    <Routes>
      <Route element={<InstructorGuards />}>
        ...
        <Route
          path={`${ROUTES.ADD_COURSE_DETAILS}`}
          element={<AddCourse_Details />}
        />
        <Route
          path={`${ROUTES.ADD_COURSE_CONTENT}`}
          element={<AddCourse_Content />}
        />
        <Route
          path={`${ROUTES.ADD_COURSE_PRICING}`}
        ...
        />
        <Route
          path={`${ROUTES.EDIT_ASSESSMENT}/:id`}
          element={<EditAssessment />}
        />
        <Route
          path={`${ROUTES.INSTRUCTOR_TRANSACTION_HISTORY}`}
          element={<InstructorTransactionHistory />}
        />
      </Route>
