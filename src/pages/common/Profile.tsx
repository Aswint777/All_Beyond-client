...
}, [userDetails]); // This will log whenever userDetails changes
    ...
    <div className="min-h-screen flex">
      ...
      <aside className="w-1/4 bg-gray-100 p-4">
        <nav className="flex flex-col gap-4">
          <a href="#" className="text-purple-600 font-semibold">Overview</a>
          <a href="#" className="text-gray-600">My Courses</a>
          <a href="#" className="text-gray-600">Analytics</a>
          <a href="#" className="text-gray-600">Assessments</a>
          <a href="#" className="text-gray-600">Messages</a>
      ...
      <main className="flex-1 bg-white p-8">
        ...
        <form className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="text" className="w-full border rounded p-2" placeholder="First Name" 
            value={userDetails?.firstName}/>
          </div>

          <div>
            <label className="block text-sm font-medium mb-1">Last Name</label>
            <input type="text" className="w-full border rounded p-2" placeholder="Last Name"
          ...
          <div>
            ...
            <input type="Number" className="w-full border rounded p-2" placeholder="Phone" 
            />
          </div>
          ...
          <div>
            ...
            <input type="password" className="w-full border rounded p-2" placeholder="Current Password" />
          </div>
        ...
        <div className="mt-6 flex justify-end gap-4">
          ...
          <button className="bg-green-500 text-white px-4 py-2 rounded">Save Changes</button>
        </div>
      </main>
      ...
      <aside className="w-1/4 p-4 flex flex-col items-center">
        ...
        <input
          ...
          />
        <p className="mt-2 text-lg font-semibold text-gray-700">{userDetails?.username}</p>
      </aside>
    </div>
          </div>
          </>
