  ...
  return (
    ...
    <div className="container mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <div className="flex space-x-3">
        <button onClick={()=>navigate("/login")} className="px-4 py-2 border rounded-full shadow-md text-gray-800 bg-white hover:bg-gray-200">
          Login
        </button>
        <button onClick={()=>navigate("/SignUp")} className="px-4 py-2 border rounded-full shadow-md bg-gray-800 text-white hover:bg-gray-900">
          Sign Up
        </button>
      </div>
    </div>
