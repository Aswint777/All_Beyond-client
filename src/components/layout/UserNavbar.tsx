            ...
            >
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118.6 14.4V11a6 6 0 10-12 0v3.4c0 .373-.135.735-.395 1.005L5 17h5m5 0v1a3 3 0 11-6 0v-1m6 0H9"
                />
              </svg>
              {/* {userDetails?.unreadNotifications > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                  {userDetails.unreadNotifications}
                </span>
              )} */}
            </button>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          ...
          <div className="flex flex-col items-center space-y-4 px-4 pb-6">
            ...
            <button
              onClick={() => {
                navigate(`${ROUTES.USER}${ROUTES.PROFILE}`);
                setIsMenuOpen(false);
              }}
