    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-between text-sm text-gray-600">
          <span
            className={activeStage === 1 ? "font-semibold text-violet-600" : ""}
          >
            Course Details
          </span>
          <span
            className={activeStage === 2 ? "font-semibold text-violet-600" : ""}
          >
            Course Content
          </span>
          <span
            className={activeStage === 3 ? "font-semibold text-violet-600" : ""}
          >
            Course Pricing
          </span>
        </div>
